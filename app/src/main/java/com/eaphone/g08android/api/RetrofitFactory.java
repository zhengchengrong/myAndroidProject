...
public class RetrofitFactory {
    ...
    private static com.eaphone.g08android.api.TestService retrofitService = new Retrofit.Builder()
            .baseUrl(BASE_URL)
            // 添加Gson转换器
            ...
            .client(httpClient)
            .build()
            .create(com.eaphone.g08android.api.TestService.class);

    // 得到实例
    public static com.eaphone.g08android.api.TestService getInstance() {
